...
<body>
    ...
    <section class="placed-orders ">
        ...
        <div class="box-container">
            ...
            <?php
            $select_orders = mysqli_query($conn, "SELECT * FROM `orders` join detail_orders on orders.id=detail_orders.id_order join products on detail_orders.pid=products.id WHERE user_id = '$user_id'") or die('query failed');
            ...
            ?>
                    <div class="box">
                        ...
                        <table class="table">
                            <tbody>
                                <?php $select_p_order = mysqli_query($conn, "SELECT id_cart, user_id, pid,unit, name, quantity, price, giacanh, sale_price, image  FROM carts JOIN products ON carts.pid= products.id  WHERE user_id = '$user_id'") or die('query failed');
