...
if (isset($_GET['update_km'])) {
   $id = mysqli_real_escape_string($conn, $_GET['update_km']);
  
}
if (isset($_POST['update_km'])) {
   $id = mysqli_real_escape_string($conn, $_GET['update_km']);
      ...
      <div class="container">
         ...
         <div class="card shadow mb-4">
            <div class="card-header py-3 row">
               <h1 class="col m-0 font-weight-bold text-primary">Sản phẩm đang khuyến mãi</h1>
               <div class="col-md-4">
               ...
               <div class="table-responsive">
                  <table class="table table-bordered text-dark text-center" id="dataTable" width="100%" cellspacing="0">
                     ...
                     <tbody class="text-center">
                        <?php
                        $fetch_products = mysqli_query($conn, "SELECT id,name,price,sale_price,giacanh FROM products WHERE sale_price <> 0 AND id=$id ") or die('query failed');
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <form class="mt-2 p-0" method="POST">                                      
                                       ...
                                       <input type="submit" value="Cập nhật" class="option-btn btn-lg" name="update_km">
                                    </form>
                                 </td>
