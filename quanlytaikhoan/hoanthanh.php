<div class="placed-orders ">
    <h1 class="title text-center text-uppercase">Đã giao</h1>
    <div class="box-container">

        <?php
        $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE user_id = '$user_id' AND payment_status = 'hoàn thành'") or die('query failed');
